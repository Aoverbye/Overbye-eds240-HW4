...
plot_final2 <- plot_base2 +
  ...
  # Place the bar chart on top, spanning the full width
  inset_element(country_bar, left = 0.05, right = 0.95, top = 0.95, bottom = 0.55) +
  
  # Stack the two timelines below with equal spacing
  inset_element(avg_year_timeline, left = 0.05, right = 0.95, top = 0.5, bottom = 0.3) +
  inset_element(timeline, left = 0.05, right = 0.95, top = 0.3, bottom = 0.05) 
